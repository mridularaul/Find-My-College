...
List<ValueItem> citylist = [
  ...
  ValueItem(label: 'Nagpur', value: '4'),
  ValueItem(label: 'Aurangabad', value: '5'),
  ValueItem(label: 'Karad', value: '6'),
  ValueItem(label: 'Navi Mumbai', value: '7'),
  ValueItem(label: 'Nanded', value: '8'),
  ValueItem(label: 'Kolhapur', value: '9'),
  ValueItem(label: 'Amravati', value: '10'),
  ValueItem(label: 'Avasari Khurd', value: '11'),
  ValueItem(label: 'Nashik', value: '12'),
  ValueItem(label: 'Shegaon', value: '13'),
  ValueItem(label: 'Ichalkaranji', value: '14'),
  ValueItem(label: 'Sangamner', value: '15'),
];
